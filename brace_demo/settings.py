"""
Django settings for brace_demo project.
"""
...
DATATYPE_LOCATIONS.append('brace_demo.datatypes')
FUNCTION_LOCATIONS.append('brace_demo.functions')
ETL_MODULE_LOCATIONS.append('brace_demo.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('brace_demo.search_components')
...
SECRET_KEY = 'django-insecure-8eb!uj)61j**hgwavb(x1f!gl$&fcg^=ry654y55v$tei6f@(w'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "brace_demo.urls"
ROOT_HOSTCONF = "brace_demo.hosts"

DEFAULT_HOST = "brace_demo"
...
ELASTICSEARCH_PREFIX = 'brace_demo'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'brace_demo.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "brace_demo",  # Ensure the project is listed before any other arches applications
    "arches_templating",
    #"arches_for_science",
)
...
WSGI_APPLICATION = 'brace_demo.wsgi.application'
...
SESSION_COOKIE_NAME = 'brace_demo'
...
# ES_MAPPING_MODIFIER_CLASSES = ["brace_demo.search.es_mapping_modifier.EsMappingModifier"]
